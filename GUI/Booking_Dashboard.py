...
class BookingDashboard(Tk):
    ...
    def __init__(self):
        ...
        # --------------------Title----------------------------------
        head = Label(text="WEL-COME TO Taxi BOOKING SYSTEM ", bg="#2A556C", font=("", 25, "bold"), fg="#FFFAFA")
        head.place(x=500, y=95)

        Frame_BookingDashboard = Label(bg="white", width=40, height=35)
        Frame_BookingDashboard.place(x=80, y=120)

        # ----------------------title 2nd-----------------------------
        Dashboardlbl = Label(text="Dashboard ", bg="White", font=("", 25, "bold"), fg="Green")
        Dashboardlbl.place(x=140, y=190)

        Dashboardlbl = Button(text="Booking System ", bg="White", border=0, font=("", 15, "bold"), fg="Black")
        Dashboardlbl.place(x=140, y=400)
